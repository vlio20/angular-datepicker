...
| showSecondaryNavigation     | `boolean`             | `false`                                                                   | `day\|month\|daytime`     | If set to `true` will show buttons to navigate by multiple step (10 by default)                                                                                                                                                                                               |  
| secondaryNavigationStep     | `number`              | `10`                                                                      | `day\|month\|daytime`     | Step of the secondary navigate button, when showSecondaryNavigation is `true`. Number of month is the months view, Number of days in the day view                                                                                                                             |  
...
| showSecondaryNavigation     | `boolean`            | `false`                                                                   | If set to `true` will show buttons to navigate by multiple step (10 by default), see secondaryNavigationStep parameter                                                                                                                                                        |  
| secondaryNavigationStep     | `number`             | `12`                                                                      | Step of the secondary navigate button, when showSecondaryNavigation is `true`. Number of month is the months view, Number of days in the day view                                                                                                                             |  
...
| monthBtnFormatter           | `(Moment) => String` | `undefined`                                                               | The formatter (callback function) of the month button in the calendar.                                                                                                                                                                                                        |  
| monthBtnCssClassCallback    | `(Moment) => String` | `undefined`                                                               | Callback which can add custom CSS classes to the month button in the calendar. Multiple classes can be returned with a space between them.                                                                                                                                    |  
| showSecondaryNavigation     | `boolean`            | `false`                                                                   | If set to `true` will show buttons to navigate by multiple years (10 by default), see secondaryNavigationStep parameter                                                                                                                                                       |  
| secondaryNavigationStep     | `number`             | `10`                                                                      | Step of the secondary navigate button, when showSecondaryNavigation is `true`. Number of month is the months view, Number of days in the day view                                                                                                                             |
| numOfMonthRows              | `1, 2, 3, 4, 6, 12`  | `4`                                                                       | Number of rows to be shown on month calendar                                                                                                                                                                                                                                  |  
