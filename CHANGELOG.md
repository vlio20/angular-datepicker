...
### Bug Fixes
- Selected month styling not present on day pickers ([???](https://github.com/vlio20/angular-datepicker/commit/???)) closes [#480](https://github.com/vlio20/angular-datepicker/issues/480)
