...
export class DatePickerService {
  ...
  getDayConfigService(pickerConfig: IDatePickerConfig): IDayCalendarConfig {
    return {
      ...
      secondaryNavigationStepMonthView: pickerConfig.secondaryNavigationStepMonthView,
      showSecondaryNavigationMonthView: pickerConfig.showSecondaryNavigationMonthView,
      secondaryNavigationStepDayView: pickerConfig.secondaryNavigationStepDayView,
      showSecondaryNavigationDayView: pickerConfig.showSecondaryNavigationDayView,
